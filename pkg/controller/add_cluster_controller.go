...
//+kubebuilder:rbac:groups=kubeadm.k8s.io,resources=kubeadmclusterproviderspecs;kubeadmclusterproviderstatuses,verbs=get;list;watch;create;update;patch;delete
func init() {
