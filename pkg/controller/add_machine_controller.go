...
//+kubebuilder:rbac:groups=kubeadm.k8s.io,resources=kubeadmmachineproviderspecs;kubeadmmachineproviderstatuses,verbs=get;list;watch;create;update;patch;delete
func init() {
